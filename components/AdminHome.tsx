    ...
    <main className="min-h-screen bg-white dark:bg-[#0b111c] text-slate-900 dark:text-zinc-100 antialiased px-6 py-16">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mt-8">
          ...
          <a href="/admin/bario-one-leads" className="rounded-2xl border border-slate-200 dark:border-zinc-800 bg-slate-50 dark:bg-[#131b2a] p-6 hover:border-slate-300 dark:hover:border-zinc-600 transition-colors">
            <div className="font-semibold">Bario One Leads & Campaigns 📣</div>
            <p className="text-xs text-slate-500 dark:text-zinc-400 mt-2">View any org's CRM leads, reply to them directly, and send or schedule bulk email campaigns — Miko can trigger these too.</p>
          </a>
          <a href="/admin/users" className="rounded-2xl border border-slate-200 dark:border-zinc-800 bg-slate-50 dark:bg-[#131b2a] p-6 hover:border-slate-300 dark:hover:border-zinc-600 transition-colors">
