...
export default function VpsAupPage() {
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 font-sans antialiased px-6 py-16">
      <div className="max-w-2xl mx-auto space-y-8">
        <div>
          <a href="/" className="text-sm text-slate-400 hover:text-white">← bario.ca</a>
        ...
        <section className="space-y-3 text-sm text-slate-300 leading-relaxed">
          <h2 className="text-lg font-semibold text-white">1. What you're getting</h2>
          <p>
        ...
        <section className="space-y-3 text-sm text-slate-300 leading-relaxed">
          <h2 className="text-lg font-semibold text-white">3. Service level</h2>
          <p>
        ...
        <section className="space-y-3 text-sm text-slate-300 leading-relaxed">
          <h2 className="text-lg font-semibold text-white">4. Payment, suspension &amp; cancellation</h2>
          <p>
        ...
        <section className="space-y-3 text-sm text-slate-300 leading-relaxed">
          <h2 className="text-lg font-semibold text-white">6. Indemnification</h2>
          <p>
        ...
        <section className="space-y-3 text-sm text-slate-300 leading-relaxed">
          <h2 className="text-lg font-semibold text-white">7. Your responsibility for data</h2>
          <p>
