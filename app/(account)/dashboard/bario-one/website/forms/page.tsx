  ...
  return (
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        ...
        <BarioOneComingSoon title="Custom form builder" phase="Phase 2" description="Build and embed custom forms that create CRM leads automatically — your site's contact form already does this behind the scenes; this brings a builder to it." />
      </div>
    </main>
  )
}
