  ...
  return (
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        ...
        <BarioOneComingSoon title="Dedicated landing pages" phase="Phase 2" description="Purpose-built, conversion-tracked landing pages distinct from your regular site pages." />
      </div>
    </main>
  )
}
