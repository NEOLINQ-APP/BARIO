  ...
  return (
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        ...
        <BarioOneComingSoon title="Security settings" phase="Phase 2" description="Two-factor authentication, active session management, and login history for your team." />
      </div>
    </main>
  )
}
