    ...
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        ...
        {gate.locked ? (
          ...
          <BarioOneComingSoon title="A real calendar view" phase="Phase 2" description="A grid calendar view of your appointments. Today you can see and manage them as a list under Appointments → Booking." />
        )}
      </div>
    </main>
  )
