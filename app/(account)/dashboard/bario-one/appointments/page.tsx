...
import BarioOneAppointments from '@/components/BarioOneAppointments'
import BarioOneLockedModule from '@/components/BarioOneLockedModule'

export const dynamic = 'force-dynamic'

export default async function BarioOneAppointmentsPage() {
  ...
  return (
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        ...
        {gate.locked ? <BarioOneLockedModule moduleKey="crm" /> : <BarioOneAppointments />}
      </div>
    </main>
  )
}
