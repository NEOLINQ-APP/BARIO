    ...
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        ...
        {gate.locked ? (
          ...
          <BarioOneComingSoon title="Staff availability" phase="Phase 2" description="Assign appointments against real staff availability windows, not just a single assignee field." />
        )}
      </div>
    </main>
  )
