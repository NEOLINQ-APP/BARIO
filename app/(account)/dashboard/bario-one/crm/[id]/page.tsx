...
import BarioOneCrmDetail from '@/components/BarioOneCrmDetail'

export const dynamic = 'force-dynamic'

export default async function BarioOneCrmCustomerPage({ params }: { params: { id: string } }) {
  ...
  return (
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-4xl">
        ...
        <BarioOneCrmDetail customerId={params.id} />
      </div>
    </main>
  )
}
