...
import BarioOneInvoiceCatalog from '@/components/BarioOneInvoiceCatalog'

export const dynamic = 'force-dynamic'

export default async function BarioOneInvoiceProductsPage() {
  ...
  return (
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-3xl">
        ...
        <h1 className="text-2xl font-bold mt-3 mb-6">Products &amp; services</h1>
        <BarioOneInvoiceCatalog />
      </div>
    </main>
  )
}
