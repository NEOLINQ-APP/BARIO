...
import BarioOneAutomations from '@/components/BarioOneAutomations'

export const dynamic = 'force-dynamic'

export default async function BarioOneCrmAutomationsPage() {
  ...
  return (
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        ...
        <h1 className="text-2xl font-bold mt-3 mb-6">Automations</h1>
        <BarioOneAutomations />
      </div>
    </main>
  )
