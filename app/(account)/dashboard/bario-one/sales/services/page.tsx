    ...
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        ...
        {gate.locked ? (
          ...
          <BarioOneComingSoon title="A dedicated service catalog" phase="Phase 2" description="A services catalog distinct from your product inventory, for quoting labor and recurring service plans." />
        )}
      </div>
    </main>
  )
