...
export default async function BarioOneOpportunitiesPage() {
    ...
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        ...
        {gate.locked ? (
          ...
          <a href="/dashboard/bario-one/crm/pipeline" className="block rounded-2xl border border-slate-200 dark:border-zinc-800 bg-white dark:bg-[#131b2a] p-5 hover:border-amber-500 dark:hover:border-[#d4af37] transition-colors">
            <p className="font-semibold">Deal pipeline →</p>
            <p className="text-sm text-slate-500 dark:text-zinc-400 mt-1">Every open deal, by stage.</p>
          </a>
        )}
      </div>
    </main>
