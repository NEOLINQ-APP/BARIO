    ...
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        ...
        {gate.locked ? (
          ...
          <BarioOneComingSoon title="Referral tracking" phase="Phase 2" description="Track who referred whom and reward it — the activity type already exists on a contact's timeline, this is the tracking UI on top of it." />
        )}
      </div>
    </main>
  )
