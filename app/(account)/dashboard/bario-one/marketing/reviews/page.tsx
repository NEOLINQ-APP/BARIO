    ...
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        ...
        {gate.locked ? (
          ...
          <BarioOneComingSoon title="Review management" phase="Phase 2" description="Collect and respond to reviews across your listings, tied back to the customer who left them." />
        )}
      </div>
    </main>
  )
