    ...
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        ...
        {gate.locked ? (
          ...
          <BarioOneComingSoon title="SMS campaigns" phase="Phase 2" description="Bulk text campaigns, built on the same suppression/opt-out protections your automations already use." />
        )}
      </div>
    </main>
  )
