...
import BarioOneGoogleAds from '@/components/BarioOneGoogleAds'

export const dynamic = 'force-dynamic'

export default async function BarioOneGoogleAdsPage() {
  ...
  return (
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-3xl">
        ...
        {gate.locked ? <BarioOneLockedModule moduleKey="crm" /> : <BarioOneGoogleAds />}
      </div>
    </main>
  )
}
