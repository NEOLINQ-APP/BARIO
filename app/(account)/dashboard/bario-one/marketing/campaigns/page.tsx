...
// Schema-only this pass (marketing_campaigns table is real) — Email
// stays the one real working channel under Marketing until this lands.
    ...
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        ...
        {gate.locked ? (
          ...
          <BarioOneComingSoon title="Multi-channel campaigns" phase="Phase 2" description="Orchestrate email, SMS, and promotions from one campaign, targeting saved audience segments. Email campaigns work today under Marketing → Email." />
        )}
      </div>
    </main>
  )
