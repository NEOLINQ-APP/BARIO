  ...
  return (
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        ...
        {gate.locked ? <BarioOneLockedModule moduleKey="crm" /> : <BarioOneComingSoon title="Run promotions" phase="Phase 2" description="Time-limited offers you can attach to campaigns and Spott listings." />}
      </div>
    </main>
  )
}
