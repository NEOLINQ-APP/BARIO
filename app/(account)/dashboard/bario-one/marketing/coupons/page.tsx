  ...
  return (
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        ...
        {gate.locked ? <BarioOneLockedModule moduleKey="crm" /> : <BarioOneComingSoon title="Coupon codes" phase="Phase 2" description="Generate redeemable codes and track which campaigns drove them." />}
      </div>
    </main>
  )
}
