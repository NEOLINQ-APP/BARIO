    ...
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        ...
        {gate.locked ? (
          ...
          <BarioOneComingSoon title="QR code generator" phase="Phase 2" description="Generate trackable QR codes for print/signage that attribute scans back through the lead source model." />
        )}
      </div>
    </main>
  )
