...
import BarioOneReports from '@/components/BarioOneReports'

export const dynamic = 'force-dynamic'

export default async function BarioOneReportsPage() {
  ...
  return (
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-4xl">
        ...
        <h1 className="text-2xl font-bold mt-3 mb-6">Reports</h1>
        <BarioOneReports />
      </div>
    </main>
  )
