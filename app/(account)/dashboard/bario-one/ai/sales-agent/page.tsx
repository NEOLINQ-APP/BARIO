...
// The backend for this already exists (ATLAS/CLOSER — lead qualification,
// close-plan tasks) but has no Bario-One-customer-facing UI yet, only an
// internal admin view. Real nuance, not "doesn't exist."
    ...
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        ...
        {gate.locked ? (
          ...
          <BarioOneComingSoon title="Your AI sales agent" phase="Phase 2" description="Automated lead qualification and close-plan drafting for your own leads, surfaced here — the engine already runs internally, this brings it to your dashboard." />
        )}
      </div>
    </main>
  )
