...
import BarioOnePayments from '@/components/BarioOnePayments'

export const dynamic = 'force-dynamic'

export default async function BarioOnePaymentsPage() {
  ...
  return (
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        ...
        <h1 className="text-2xl font-bold mt-3 mb-6">Payments</h1>
        <BarioOnePayments />
      </div>
    </main>
  )
