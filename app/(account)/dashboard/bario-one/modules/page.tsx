...
import BarioOneModules from '@/components/BarioOneModules'

export const dynamic = 'force-dynamic'

export default async function BarioOneModulesPage() {
  ...
  return (
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        ...
        <h1 className="text-2xl font-bold mt-3 mb-6">Modules</h1>
        <BarioOneModules />
      </div>
    </main>
  )
