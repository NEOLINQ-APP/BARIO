  ...
  return (
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        ...
        <BarioOneComingSoon title="Manage your Spott listing" phase="Phase 2" description="Spott isn't connected to Bario One yet — see the Spott overview for details. Once linked, you'll manage your business listing here." />
      </div>
    </main>
  )
}
