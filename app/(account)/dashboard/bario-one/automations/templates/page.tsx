  ...
  return (
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        <h1 className="text-2xl font-bold mb-6">Automation Templates</h1>
        {gate.locked ? (
          <BarioOneLockedModule moduleKey="crm" />
        ) : (
          <BarioOneComingSoon title="Pre-built automation templates" phase="Phase 2" description="Common automations ready to enable in one click, instead of building each rule from scratch under Workflows." />
        )}
      </div>
    </main>
  )
