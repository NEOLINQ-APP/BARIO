...
import BarioOneAutomationRuns from '@/components/BarioOneAutomationRuns'
import BarioOneLockedModule from '@/components/BarioOneLockedModule'

export const dynamic = 'force-dynamic'

export default async function BarioOneAutomationRunsPage() {
  ...
  return (
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        <h1 className="text-2xl font-bold mb-6">Automation Runs</h1>
        {gate.locked ? <BarioOneLockedModule moduleKey="crm" /> : <BarioOneAutomationRuns />}
      </div>
    </main>
  )
}
