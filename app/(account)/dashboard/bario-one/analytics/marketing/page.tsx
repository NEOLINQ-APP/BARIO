  ...
  return (
    <main className="px-6 py-10 md:py-16 text-slate-900 dark:text-zinc-100">
      <div className="max-w-2xl">
        <h1 className="text-2xl font-bold mb-6">Marketing Analytics</h1>
        {gate.locked ? (
          <BarioOneLockedModule moduleKey="crm" />
        ) : (
          <BarioOneComingSoon title="Marketing performance" phase="Phase 2" description="Campaign-level performance once campaigns exist. Revenue by lead source is already live under Analytics → Sales Analytics." />
        )}
      </div>
    </main>
  )
