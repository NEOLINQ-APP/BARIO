    ...
    <main className="min-h-screen bg-slate-950 text-slate-100 font-sans antialiased selection:bg-cyan-500 selection:text-slate-950">
      <nav className="border-b border-slate-800/80 px-6 sm:px-12 py-4 flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-6 text-sm font-medium">
          ...
          <a href="/vps" className="text-white">VPS Servers</a>
      ...
      <section id="plans" className="py-20 px-6 sm:px-12 max-w-6xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-14 space-y-3">
          ...
          <p className="text-slate-400">Longer commitments cost less per month — pick a billing cycle below to see the difference.</p>
        </div>
        <VpsPricingSection />
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            <div className="text-center space-y-2">
              ...
              <h3 className="font-bold text-white">Sign up &amp; choose a size</h3>
              <p className="text-sm text-slate-400">Pick a tier and billing cycle from your dashboard, add your SSH key (or request a one-time password).</p>
            </div>
            <div className="text-center space-y-2">
              ...
              <h3 className="font-bold text-white">We provision it</h3>
              <p className="text-sm text-slate-400">Your server is created automatically the moment payment goes through — usually ready within a minute or two.</p>
            </div>
            <div className="text-center space-y-2">
              ...
              <h3 className="font-bold text-white">Connect &amp; manage</h3>
              <p className="text-sm text-slate-400">SSH in with your key, run whatever you need. Manage or cancel anytime from Dashboard → Servers.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 sm:px-12 max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          <div className="bg-slate-900/60 border border-slate-800 p-6 rounded-xl space-y-2">
            <h3 className="font-bold text-lg text-white">Is this managed or self-managed?</h3>
          ...
          <div className="bg-slate-900/60 border border-slate-800 p-6 rounded-xl space-y-2">
            <h3 className="font-bold text-lg text-white">What can I run on it?</h3>
            <p className="text-slate-400 text-sm">Anything you'd run on a normal Linux server — your own websites, apps, databases, or tools. See our Acceptable Use Policy for what's not allowed.</p>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 p-6 rounded-xl space-y-2">
            <h3 className="font-bold text-lg text-white">How do I access my server?</h3>
            <p className="text-slate-400 text-sm">Via SSH, using the key you provide at order time — or a one-time root password if you don't have an SSH key yet.</p>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 p-6 rounded-xl space-y-2">
            <h3 className="font-bold text-lg text-white">Can I switch billing cycles later?</h3>
            <p className="text-slate-400 text-sm">Cancel and re-order at a different cycle from your dashboard — each server is its own subscription, managed from Billing.</p>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 p-6 rounded-xl space-y-2">
            <h3 className="font-bold text-lg text-white">What happens if a payment fails?</h3>
            <p className="text-slate-400 text-sm">Your server is suspended (not deleted) after our payment processor's retry attempts are exhausted, giving you time to update your card before anything is removed.</p>
          </div>
        </div>
