...
export default async function DialerPage({ searchParams }: { searchParams: { number?: string } }) {
  ...
  return <BarioDialer initialNumber={searchParams.number} />
}
