...
export const metadata: Metadata = {
  ...
  manifest: '/dialer-afc-manifest.json',
...
export default async function AfcDialerPage({ searchParams }: { searchParams: { number?: string } }) {
  ...
  return <BarioDialer initialNumber={searchParams.number} lockedBusinessKey="afc" swScope="/admin/dialer/afc" />
}
